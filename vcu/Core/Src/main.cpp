...
static void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.NominalTimeSeg1 = 237;
...
static void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.NominalTimeSeg1 = 237;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, IMD_Indicator_Pin|BMS_Indicator_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Shutdown_IN_Pin R2D_Button_Pin */
  GPIO_InitStruct.Pin = Shutdown_IN_Pin|R2D_Button_Pin;
  ...
  /*Configure GPIO pins : IMD_Indicator_Pin BMS_Indicator_Pin */
  GPIO_InitStruct.Pin = IMD_Indicator_Pin|BMS_Indicator_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart){
	vehicle::imu.updateState();
	if(HAL_UART_Receive_DMA(huart, vehicle::imu.getBuffer(), drivers::imu::PACKET_SIZE)!= HAL_OK){
		Error_Handler();
	}
}
/* USER CODE END 4 */
...
#endif /* USE_FULL_ASSERT */
>>>>>>> 819e647 (Declare tasks as static)
